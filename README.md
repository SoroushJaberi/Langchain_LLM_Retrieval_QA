...
### 7. ⚙️ Load Model and Setup Pipeline
...
- **Capabilities**: DPR
 ...
 provides an efficient way to retrieve passages from a large corpus using dense vectors, significantly improving retrieval performance.
...
This version includes all parts of the README in code format as requested.
